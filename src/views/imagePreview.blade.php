<div class="rounded mt-3 
    ...
    @else
        <img src="{{ $image ?? 'https://fakeimg.pl/250x100/' }}" class="card-img-top" alt="..." id="imagePreview-{{ $id }}-uploader">
    @endif

    <a href="#download" class="flex item-center mt-3 text-sm text-blue-500">
