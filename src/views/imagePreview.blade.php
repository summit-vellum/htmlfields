<div class="rounded mt-3 
    ...
    @if(empty($image))
        <img 
            ...
            class="w-full" 
            alt="..." 
            id="imagePreview-{{ $id }}-uploader">
    @else
        <img src="{{ asset($image) ?? 'https://fakeimg.pl/250x100/' }}" class="card-img-top" alt="..." id="imagePreview-{{ $id }}-uploader">
    @endif

    <a href="{{ asset($image) ?? 'https://fakeimg.pl/250x100/' }}" download class="flex item-center mt-3 text-sm text-blue-500">
